$(document).ready(function(e){
    ...
    jsonObject.games.forEach((i)=>loadgames(i));
...
function loadgames(data){
    ...
    '<div class="games-1 align-items-center p-2 text-center"> <img src="'+data.image+'" class="rounded" width="150" height="100">'+
...
'</div>';
document.getElementById("home_games").appendChild(li);
}